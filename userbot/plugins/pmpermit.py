...
USER_BOT_NO_WARN = ("[──▄█▀█▄─────────██ \n▄████████▄───▄▀█▄▄▄▄ \n██▀▼▼▼▼▼─▄▀──█▄▄ \n█████▄▲▲▲─▄▄▄▀───▀▄ \n██████▀▀▀▀─▀────────▀▀](tg://user?id=742506768)\n\n"
                    ...
                    "Leave your name, phone number, address and 100000k$ and Maybe you'll get a reply within 2 days.`\n\n"
    ...
    async def approve_p_m(event):
        ...
        if event.is_private:
            if not pmpermit_sql.is_approved(chat.id):
                ...
                await event.edit("My Master Approved U Nibba !!(Chal Fir 10k$ Bhej Bc) [{}](tg://user?id={})".format(firstname, chat.id))
